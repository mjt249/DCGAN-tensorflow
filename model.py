...
# Modules for classifier
    ...
    def classifier(self, image):
        with tf.variable_scope("classifier") as scope:
            ...
            h0 = lrelu(conv3d(image, self.df_dim, name='c_h0_conv'))
            h1 = lrelu(self.d_bn1(conv3d(h0, self.df_dim * 2, name='c_h1_conv')))
            h2 = lrelu(self.d_bn2(conv3d(h1, self.df_dim * 4, name='c_h2_conv')))
            h3 = lrelu(self.d_bn3(conv3d(h2, self.df_dim * 8, name='c_h3_conv')))
